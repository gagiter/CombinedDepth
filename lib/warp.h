...
//torch::Tensor warp_forward(torch::Tensor image, torch::Tensor sample);
//torch::Tensor warp_backward(torch::Tensor image, torch::Tensor sample)
//
//torch::Tensor warp_cuda_forward(torch::Tensor image, torch::Tensor sample);
//torch::Tensor warp_cuda_backward(torch::Tensor image, torch::Tensor sample);
